...
@if ($payumoney->status == 1)
  <div class="option-block">
    <div class="checkbox">
      <label>
        <input name="method" class="input-check" type="radio" value="payumoney" data-tabid="payumoney"
          data-action="{{ route('product.payumoney.submit') }}">
  ...
  <div class="row gateway-details" id="tab-payumoney">
    ...
    <div class="col-lg-6 mb-4">
      <div class="form-element">
        <input class="input-field" name="payumoney_first_name" type="text"
